...
class Tracker:
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        # Calculate text dimensions for sizing
        text1 = f"Team 1 Ball Control: {0:.2f}%"
        text2 = f"Team 2 Ball Control: {0:.2f}%"
        ...
        rect_height = 2.5 * text1_height + 3 * padding
        
        # Position rectangle (bottom right)
        x1 = width - rect_width - padding
        y1 = height - rect_height - padding
        x2 = width - padding
        y2 = height - padding
        
        # Draw more transparent rectangle
        overlay = frame.copy()
        ...
        text_y1 = int(y1 + text1_height + padding)
        text_y2 = int(text_y1 + text1_height + padding)
        ...
        if total_frames == 0:
            ...
            team1 = team_1_frames/total_frames
            team2 = team_2_frames/total_frames
        
        # Draw text with black outline for better visibility
        cv2.putText(frame, f"Team 1 Ball Control: {team1*100:.2f}%", 
                    (text_x, text_y1), cv2.FONT_HERSHEY_SIMPLEX, 
                    font_scale, (0,0,0), thickness+1)
        cv2.putText(frame, f"Team 2 Ball Control: {team2*100:.2f}%", 
